...
const Team_management = () => {
    ...
    const handleSelectAll = (e) => {
        if (e.target.checked) {
            const allIds = recordsData.map((record) => record.id);
    ...
    const handleDeleteSelected = () => {
        const updatedRecords = initialRecords.filter((record) => !selectedIds.includes(record.id));
    ...
    const handleAddTeam = () => {
        ...
        setInitialRecords([newTeam, ...initialRecords]);
    };
        ...
        <div className="space-y-6">
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Team Management</h5>
                ...
                <input
                    type="text"
                    className="form-input w-auto mb-3"
                    placeholder="Search..."
                    value={search}
                            ...
                            <tr>
                                <th>
                                    <input
                                        ...
                                        checked={selectedIds.length === recordsData.length && recordsData.length > 0}
                                    />
                                </th>
                                <th>ID</th>
                                <th>First Name</th>
                ...
                <div className="flex justify-between mt-5">
                    <span>
                        Showing {recordsData.length} of {initialRecords.length} entries
                    </span>
                    <div>
